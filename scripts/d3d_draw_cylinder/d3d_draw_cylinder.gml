...
/// @param {real} [c] The vertex color to draw the cylinder with (defaults to the current draw color)
/// @param {real} [a] The vertex color to draw the cylinder with (defaults to the current draw alpha)
function d3d_draw_cylinder(x1, y1, z1, x2, y2, z2, tex = -1, hrepeat = 1, vrepeat = 1, closed = true, steps = 32, c = draw_get_colour(), a = draw_get_alpha()) {
